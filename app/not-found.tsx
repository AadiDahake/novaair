...
export default function NotFound() {
  return (
    <div className="py-24 text-center">
      <p className="text-sm font-bold uppercase tracking-[0.16em] text-blue">Page not found</p>
      <h1 className="mt-3 text-[2.8rem] font-extrabold tracking-tight text-navy">
